...
uav3 = net.addStation('uav3', ip='11.0.0.3', mac='00:01:00:00:00:03',
                          cls=DockerSta, dimage="openvswitch/ovs:2.11.2_debian", cpu_shares=20, position='100,115,0')
uav4 = net.addStation('uav4', ip='11.0.0.4', mac='00:01:00:00:00:04',
                          cls=DockerSta, dimage="openvswitch/ovs:2.11.2_debian", cpu_shares=20, position='125,100,0')
sta2 = net.addStation('sta2', ip='11.0.0.12', mac='00:02:00:00:00:12',
cls=DockerSta, dimage="openvswitch/ovs:2.11.2_debian", cpu_shares=20, position='150,75,0')                    
